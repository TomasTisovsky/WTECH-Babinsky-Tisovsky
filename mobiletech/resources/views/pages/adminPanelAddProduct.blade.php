...
<main>
        <div class="container-fluid back-ground-color pb-5">
            <div class="container-md bg-white pb-5">
                <form id="addForm" class="container-md" enctype="multipart/form-data"  method="POST" action="{{ route('products.store', ['category' => $category->id]) }}">
                ...
                <div class="row mt-2">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4 d-flex justify-content-center my-3">
                            <a class="btn  px-5 cart-btn" href="{{ url()->previous() }}">Späť</a>
                        </div>
                    </div>
                </form>
            </div>
