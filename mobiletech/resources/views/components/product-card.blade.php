<div class="card product-card ">
    <div class="card-body  product-card-main-page modified-card-body">
        ...
        <a class="product-card-image-anchor" href="{{ route('product-detail.show', ['product_id' => $product->id]) }}"><img class="img-fluid card-main-image card-image-top p-0" src="{{asset('resources/phones/'.$image)}}"
